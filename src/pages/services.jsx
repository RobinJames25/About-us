import careerTalk from '../assets/Career Talk.jpg';
import interviewPrep from "../assets/Interview Prep.jpg";
import workPlace from '../assets/WorkPlace.jpg';
import cvReview from '../assets/CV Review.jpg';
      ...
      <main>
        ...
        <section className="services-row" aria-label="CV Reviews and Writing">
          <div className="services-box">
            ...
            <div className="services-content">
              ...
              <img src={cvReview} alt="CV Writing Service Illustration" width="300" />
            </div>
          </div>
        </section>
        ...
        <section className="services-row" aria-label="Mock Interviews and Preparation">
          <div className="services-box">
            ...
            <div className="services-content">
              <img src={interviewPrep} alt="Mock Interview Coaching Session Image" width="300" />
              <div className="text">
                <p>
        ...
        <section className="services-row" aria-label="Career Talks and Workshops">
          <div className="services-box">
            ...
            <div className="services-content">
              ...
              <img src={careerTalk} alt="Career Workshop Presentation Image" width="300" />
            </div>
          </div>
        </section>
        ...
        <section className="services-row" aria-label="Internships and Job Placement">
          <div className="services-box">
            ...
            <div className="services-content">
              <img src={workPlace} alt="Internship and Placement Program Visual" width="300" />
              <div className="text">
                <p>
